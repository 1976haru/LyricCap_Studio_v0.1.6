...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("LyricCap Studio v0.1.6 - Separate Vocals + Forced Alignment + CapCut SRT")
    ...
    def _build(self):
        ...
        ttk.Label(
            opts,
            text="※ v0.1.6: Demucs를 별도 프로세스로 실행해 vocals.wav를 만든 뒤, 그 보컬 파일에 가사를 강제 정렬합니다. 싱크 실패 시 가짜 시간분배를 만들지 않습니다.",
